import FinalLearnM
from FinalLearnM import applot
import pandas as pd
...
frame1 = Frame(root,height=300,width=500)
frame1.pack()
frame2 = Frame(root,height=10,width=500)
frame2.pack()
frame3 = Frame(root,height=10,width=500)
frame3.pack()
frame4 = Frame(root,height=30,width=500)
frame4.pack()
frame5 = Frame(root,height=30,width=500)
frame5.pack()
frame6 = Frame(root,height=30,width=500)
frame6.pack()
frame7 = Frame(root,height=30,width=500)
frame7.pack()
frame8 = Frame(root,height=30,width=500)
frame8.pack()
frame9 = Frame(root,height=30,width=500)
frame9.pack()
frame10 = Frame(root,height=30,width=500)
frame10.pack()
...
label3 = Label(frame8,text = "2017 Actual India Energy Map    ")
label3.grid(row = 0)
